<template>
            ...
            >
              <template v-if="platform.id === 'ios'">
                <a 
                  ...
                  id="ios"
                >
                  <img class="icon mb-8" :src="platform.icon" :alt="platform.name" />
                ...
                <a 
                  ...
                  target="_blank"
                >
                  <img class="qr-code mb-8" :src="platform.qrCode" :alt="`扫描下载,${platform.name}`" />
              ...
              <template v-else-if="platform.id === 'windows'">
                ...
                <a 
                  ...
                  target="_blank"
                >
                  <img class="icon mb-8" src="/img/dow_icon.svg" :alt="`${platform.name},下载`" />
                  <i class="txt-4001624 txt">下载</i>
                </a>
              </template>
            </li>
  ...
  const platforms = ref([
    ...
    },
    {
      ...
      normalLink: 'https://www.dootask.com/desktop/publish/latest?platform=android'
    },
    {
      id: 'mac',
      name: 'macOS',
    ...
    },
    {
      ...
      normalLink: 'https://www.dootask.com/desktop/publish/latest?platform=win&arch=x64'
    }
  ])
