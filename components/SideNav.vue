  ...
  <nav class="side_nav">
    ...
    >
      <div class="side_to_top_wrapper">
        ...
        >
          <path
            d="M4 12.2531C3.58579 12.2531 3.25 11.9173 3.25 11.5031C3.25 11.0889 3.58579 10.7531 4 10.7531L12 10.7531C12.4142 10.7531 12.75 11.0889 12.75 11.5031C12.75 11.9173 12.4142 12.2531 12 12.2531H4Z"
          ></path>
          <path
            d="M10.803 4.13636C11.0959 3.84346 11.5708 3.84346 11.8637 4.13636C12.1566 4.42925 12.1566 4.90412 11.8637 5.19702L8.53037 8.53035C8.38972 8.671 8.19895 8.75002 8.00004 8.75002C7.80113 8.75002 7.61036 8.671 7.46971 8.53035L4.13638 5.19702C3.84348 4.90412 3.84348 4.42925 4.13638 4.13636C4.42927 3.84346 4.90414 3.84346 5.19704 4.13636L8.00004 6.93936L10.803 4.13636Z"
          ></path>
        </svg>
      </div>
    </div>
...
const tooltipQrcodeVisible = ref(false);

const showBackTopButton = ref(false);
const handleScroll = () => {
  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
    showBackTopButton.value = true;
  } else {
